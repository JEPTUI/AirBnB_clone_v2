#!/usr/bin/python3
"""Test module implementation for review """
import unittest
import pep8
...
class TestReview(unittest.TestCase):
    ...
    def setUpClass(cls):
        """ Sets up unittest"""
        cls.rev = Review()
        cls.rev.user_id = "Alice and Kevin 123"
        cls.rev.place_id = "Martin and Steve's room at SF"
        cls.rev.text = "Awesome Team includes Moses"
